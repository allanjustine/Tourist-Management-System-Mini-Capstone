            ...
            <div class="row h-100 align-items-center py-5">
                <div class="col-lg-6">
                    ...
                    <p class="lead text-muted">A travel and tour agency sells services and products relating to travel. As
                        ...
                        hotel accommodations, and many other items to supplement your main product line.
                    </p>
                </div>
    ...
    <div class="bg-white py-5">
        <div class="container py-5">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 order-2 order-lg-1" data-aos="fade-up-right"><i class="far fa-chart-simple fa-2x mb-3 text-primary"></i>
                ...
                <div class="col-lg-5 px-5 mx-auto order-1 order-lg-2" data-aos="fade-up-left"><img
                        src="https://bootstrapious.com/i/snippets/sn-about/img-1.jpg" alt=""
                        class="img-fluid mb-4 mb-lg-0"></div>
            </div>
            <div class="row align-items-center">
                <div class="col-lg-5 px-5 mx-auto" data-aos="flip-right"><img src="https://bootstrapious.com/i/snippets/sn-about/img-2.jpg"
                        alt="" class="img-fluid mb-4 mb-lg-0"></div>
                <div class="col-lg-6" data-aos="flip-left"><i class="far fa-leaf fa-2x mb-3 text-primary"></i>
                    <h2 class="font-weight-light">Lorem ipsum dolor sit amet</h2>
                    <p class="font-italic text-muted mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                        eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><a href="#"
                        class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
    ...
    <div class="bg-light py-5">
        <div class="container py-5">
            ...
            <div class="row text-center">
                <div class="col-xl-3 col-sm-6 mb-5" data-aos="fade-up-left">
                ...
                <div class="col-xl-3 col-sm-6 mb-5" data-aos="fade-down">
                    <div class="bg-white rounded shadow-sm py-5 px-4"><img
                ...
                <div class="col-xl-3 col-sm-6 mb-5" data-aos="fade-up">
                    <div class="bg-white rounded shadow-sm py-5 px-4"><img
                ...
                <div class="col-xl-3 col-sm-6 mb-5" data-aos="fade-up-right">
                    <div class="bg-white rounded shadow-sm py-5 px-4"><img
