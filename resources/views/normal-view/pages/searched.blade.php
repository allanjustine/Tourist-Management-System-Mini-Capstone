...
@section('content')
    ...
    <div class="container">
        ...
        @if ($search)
            <h2 class="my-4"><i class="far fa-location-dot"></i> Search result for "{{ $search }}"</h1>
                <div class="row">
                            ...
                            <div class="card-img-overlay d-flex flex-column justify-content-between">
                                <div class="d-flex justify-content-between align-items-start">
                                    <h5 class="card-title text-white p-1 rounded"
                                        ...
                                        {{ $category->name }}</h5>
                                    <p class="card-text text-white p-1 rounded"
                                        style="background: rgba(0, 0, 0, 0.5);">
                                        @if ($category->posts_count <= 1)
                                            <i class="far fa-location-dot   "></i> {{ $category->posts_count }} City
                                        @else
                                            <i class="far fa-location-dot   "></i> {{ $category->posts_count }}
                                            Cities
                                        @endif
                                    </p>
                                </div>
            ...
            @empty
                ...
                <div class="text-center">
                    <a href="#" class="btn btn-secondary my-2 w-25" onclick="goBack()"><i
                            class="far fa-arrow-left"></i> Search
                        another</a>
                </div>
            @endforelse
        </div>
